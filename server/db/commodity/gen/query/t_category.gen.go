...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.FID = field.NewInt64(tableName, "f_id")
	_category.FTenantID = field.NewString(tableName, "f_tenant_id")
	_category.FGroupID = field.NewInt64(tableName, "f_group_id")
	_category.FCode = field.NewString(tableName, "f_code")
	_category.FName = field.NewString(tableName, "f_name")
	_category.FDescription = field.NewString(tableName, "f_description")
	_category.FStatus = field.NewInt16(tableName, "f_status")
	_category.FCreatedBy = field.NewString(tableName, "f_created_by")
	_category.FUpdatedBy = field.NewString(tableName, "f_updated_by")
	_category.FCreatedAt = field.NewTime(tableName, "f_created_at")
	_category.FUpdatedAt = field.NewTime(tableName, "f_updated_at")
	_category.FVersion = field.NewInt64(tableName, "f_version")
	_category.FRemark = field.NewString(tableName, "f_remark")
	_category.FDeleted = field.NewInt16(tableName, "f_deleted")
	_category.FParentID = field.NewInt64(tableName, "f_parent_id")
...
func (c *category) updateTableName(table string) *category {
	...
	c.FTenantID = field.NewString(table, "f_tenant_id")
	c.FGroupID = field.NewInt64(table, "f_group_id")
	c.FCode = field.NewString(table, "f_code")
	c.FName = field.NewString(table, "f_name")
	c.FDescription = field.NewString(table, "f_description")
	c.FStatus = field.NewInt16(table, "f_status")
	c.FCreatedBy = field.NewString(table, "f_created_by")
	c.FUpdatedBy = field.NewString(table, "f_updated_by")
	c.FCreatedAt = field.NewTime(table, "f_created_at")
	c.FUpdatedAt = field.NewTime(table, "f_updated_at")
	c.FVersion = field.NewInt64(table, "f_version")
	c.FRemark = field.NewString(table, "f_remark")
	c.FDeleted = field.NewInt16(table, "f_deleted")
	c.FParentID = field.NewInt64(table, "f_parent_id")
...
func (c *category) fillFieldMap() {
	...
	c.fieldMap["f_tenant_id"] = c.FTenantID
	c.fieldMap["f_group_id"] = c.FGroupID
	c.fieldMap["f_code"] = c.FCode
	c.fieldMap["f_name"] = c.FName
	c.fieldMap["f_description"] = c.FDescription
	c.fieldMap["f_status"] = c.FStatus
	c.fieldMap["f_created_by"] = c.FCreatedBy
	c.fieldMap["f_updated_by"] = c.FUpdatedBy
	c.fieldMap["f_created_at"] = c.FCreatedAt
	c.fieldMap["f_updated_at"] = c.FUpdatedAt
	c.fieldMap["f_version"] = c.FVersion
	c.fieldMap["f_remark"] = c.FRemark
	c.fieldMap["f_deleted"] = c.FDeleted
	c.fieldMap["f_parent_id"] = c.FParentID
}
