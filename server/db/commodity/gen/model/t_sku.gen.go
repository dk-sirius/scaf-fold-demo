...
const TableNameSku = "t_sku"

// Sku mapped from table <t_sku>
type Sku struct {
	...
	FPrice       float64   `gorm:"column:f_price;not null" json:"f_price"`                 // 价格
	FCurrency    int16     `gorm:"column:f_currency;not null;default:1" json:"f_currency"` // 货币类型: UNKNOWN: 0 RMB: 1 USD: 2
	...
	FItemID      int64     `gorm:"column:f_item_id" json:"f_item_id"`                      // 商品id
}
